...
std::unordered_set<int> Ransac(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol) // TODO: Fill in this function
{
...
int main ()
{
	...
	std::unordered_set<int> inliers = Ransac(cloud, 1, 0.5);
